...
{
    public class EmployessService : IEmployeeService<Employee, EmployeeDTO> 
    {
        #region Globals
        ...
        #region Constructor
        public EmployessService(IMapper mapper, ICacheService cacheService, UnitOfWorkFactory unitOfWorkFactory)
        {
            _mapper = mapper;
