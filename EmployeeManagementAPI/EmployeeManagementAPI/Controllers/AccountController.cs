...
namespace EmployeeManagement.Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private readonly HashingHelper _hash;
        private readonly IEmailSender _emailSender;
        private readonly ISmsSender _smsSender;

        // Constructor to inject required services
        public AccountController(HashingHelper hash, JwtTokenGenrator tokenGenrator, IAccountService dbAccountService, IEmailSender emailSender,ISmsSender smsSender)
        {
            _hash = hash;
        ...
        [HttpPost("/SendSms")]
        public void SmsSender(string recipentNumber,string message)
        {
            _smsSender.SendSms(recipentNumber, message);
        }
    }
}
